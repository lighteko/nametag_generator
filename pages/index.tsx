...
export default function Home() {
  ...
  const generateNametags = async () => {
    if (
      !excelFile ||
      (bigNametagFiles.length === 0 && smallNametagFiles.length === 0)
    ) {
      ...
      <div className={styles.container}>
            ...
            <div className={styles.instructionContent}>
              <div className={styles.instructionBox}>
                ...
                <ul className={styles.formatNotes}>
                  <li>
                    <strong>성명</strong>: 이름표에 표시될 이름 (필수)
                  </li>
                  <li>
                    <strong>교회</strong>: 교회명 (비어있어도 됨)
                  </li>
                  <li>
                    <strong>나이/학년/직책</strong>: 추가 정보 (필수), 예시:
                    6세, 5학년, 중3, 선생님, 전도사님, 목사님 등
                  </li>
                  <li>
                    <strong>학생 여부</strong>: T = 학생 (작은 이름표), F = 일반
                    (큰 이름표)
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.instructionBox}>
                ...
                <ul>
                  <li>
                    <strong>큰 이름표</strong>: 교사용 배경 이미지 (PNG, JPG 등)
                  </li>
                  <li>
                    <strong>작은 이름표</strong>: 학생용 배경 이미지 (PNG, JPG
                    등)
                  </li>
              ...
              <div className={styles.instructionBox}>
                ...
                <ul>
                  <li>
                    체크박스를 선택하면 개별 파일 대신 A4 용지에 배치된 이미지를
                    생성합니다
                  </li>
                  <li>학생용과 교사용 이름표 크기를 각각 설정할 수 있습니다</li>
                  <li>
                    자동으로 회전하여 최적의 배치로 종이 낭비를 최소화합니다
                  </li>
                  <li>
                    학생용 이름표는 10개의 여분 빈 이름표가 자동으로 추가됩니다
                  </li>
              ...
              <div className={styles.instructionBox}>
                <h3>📸 결과 예시</h3>
                <p>다음은 실제 생성되는 이름표의 예시입니다:</p>
                <div className={styles.exampleImages}>
                  <div className={styles.exampleSection}>
                    <h4>개별 이름표</h4>
                    <div className={styles.exampleGrid}>
                      <div className={styles.exampleItem}>
                        <img src="/examples/sample_big.png" alt="큰 이름표 예시" className={styles.exampleImage} />
                        <p>큰 이름표 (교사용)</p>
                      </div>
                      <div className={styles.exampleItem}>
                        <img src="/examples/sample_small.png" alt="작은 이름표 예시" className={styles.exampleImage} />
                        <p>작은 이름표 (학생용)</p>
                      </div>
                    </div>
                  </div>
                  <div className={styles.exampleSection}>
                    ...
                    <div className={styles.exampleGrid}>
                      <div className={styles.exampleItem}>
                        <img src="/examples/sample_a4_big.png" alt="A4 배치 큰 이름표" className={styles.exampleImage} />
                        <p>A4 배치 - 큰 이름표</p>
                      </div>
                      <div className={styles.exampleItem}>
                        <img src="/examples/sample_a4_small.png" alt="A4 배치 작은 이름표" className={styles.exampleImage} />
                        <p>A4 배치 - 작은 이름표</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className={styles.uploadSection}>
          <div className={styles.uploadBox}>
            ...
            <div
              ...
              className={`${styles.dropzone} ${
                bigNametagDropzone.isDragActive ? styles.active : ""
              }`}
            >
            ...
            <div className={styles.fileList}>
              {bigNametagFiles.map((file, index) => (
                <div key={index} className={styles.fileItem}>
                  <span>{file.name}</span>
                  <button onClick={() => removeBigNametagFile(index)}>
                    삭제
                  </button>
                </div>
              ))}
          ...
          <div className={styles.uploadBox}>
            ...
            <div
              ...
              className={`${styles.dropzone} ${
                smallNametagDropzone.isDragActive ? styles.active : ""
              }`}
            >
            ...
            <div className={styles.fileList}>
              {smallNametagFiles.map((file, index) => (
                <div key={index} className={styles.fileItem}>
                  <span>{file.name}</span>
                  <button onClick={() => removeSmallNametagFile(index)}>
                    삭제
                  </button>
                </div>
              ))}
        ...
        <div className={styles.excelSection}>
          ...
          <div
            ...
            className={`${styles.dropzone} ${
              excelDropzone.isDragActive ? styles.active : ""
            }`}
          >
                ...
                <div className={styles.widthInputRow}>
                  <label>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setStudentWidthMm(Number(e.target.value))
                      }
                      min="50"
                      max="150"
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNonStudentWidthMm(Number(e.target.value))
                      }
                      min="50"
                      max="150"
                      className={styles.widthInput}
